...
import LatestSkeletonCard from "@/app/(mangahat)/(home)/_components/latest-update/latest-skeleton-card";
import LatestMangaCard from "@/app/(mangahat)/(home)/_components/latest-update/latest-manga-card";
